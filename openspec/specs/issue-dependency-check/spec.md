# Issue Dependency Check Specification

## Purpose

Provide a single-call verdict on whether an issue is blocked by its open dependencies, aggregating the full dependency list so AI clients do not have to paginate and filter themselves.
